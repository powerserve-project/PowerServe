        ...
        for type_v in TYPES_KV:
            for head_size in get_head_sizes(type_k, type_v):
                with open(
                    ...
                    f.write(
                        SOURCE_FATTN_VEC.format(vkq_size=vkq_size, head_size=head_size, type_k=type_k, type_v=type_v)
                    )
        ...
        with open(f"fattn-wmma-f16-instance-kq{kq_acc_t}-cpb{cols_per_block}.cu", "w") as f:
            ...
            for head_size in [64, 80, 96, 112, 128, 256]:
                ...
                if (
                    ...
                    continue
                f.write(
                    SOURCE_FATTN_WMMA_CASE.format(kq_acc_t=kq_acc_t, cols_per_block=cols_per_block, head_size=head_size)
                )
