...
inline void setQnnOpConfigPackageName(Qnn_OpConfig_t *const opConfig, const char *const packageName) {
...
inline void setQnnOpConfigParams(Qnn_OpConfig_t &opConfig, uint32_t const numOfParams, Qnn_Param_t *const params) {
    if (opConfig.version == QNN_OPCONFIG_VERSION_1) {
...
inline void setQnnOpConfigParams(
    Qnn_OpConfig_t *const opConfig, uint32_t const numOfParams, Qnn_Param_t *const params
) {
    setQnnOpConfigParams(*opConfig, numOfParams, params);
}

inline void setQnnOpConfigInputs(
    Qnn_OpConfig_t &opConfig, uint32_t const numOfInputs, Qnn_Tensor_t *const inputTensors
) {
    if (opConfig.version == QNN_OPCONFIG_VERSION_1) {
...
inline void setQnnOpConfigInputs(
    Qnn_OpConfig_t *const opConfig, uint32_t const numOfInputs, Qnn_Tensor_t *const inputTensors
) {
    setQnnOpConfigInputs(*opConfig, numOfInputs, inputTensors);
}

inline void setQnnOpConfigOutputs(
    Qnn_OpConfig_t &opConfig, uint32_t const numOfOutputs, Qnn_Tensor_t *const outputTensors
) {
    if (opConfig.version == QNN_OPCONFIG_VERSION_1) {
...
inline void setQnnOpConfigOutputs(
    Qnn_OpConfig_t *const opConfig, uint32_t const numOfOutputs, Qnn_Tensor_t *const outputTensors
) {
...
inline void setQnnTensorDataFormat(Qnn_Tensor_t *const tensor, const Qnn_TensorDataFormat_t format) {
...
inline void setQnnTensorIsDynamicDimensions(Qnn_Tensor_t &tensor, uint8_t *const isDynamicDimensions) {
...
inline void setQnnTensorSetInputTensors(
    Qnn_TensorSet_t &tensorSet, Qnn_Tensor_t *inputTensors, uint32_t const numInputs
) {
    if (tensorSet.version == QNN_TENSOR_SET_VERSION_1) {
...
inline void setQnnTensorSetOutputTensors(
    Qnn_TensorSet_t &tensorSet, Qnn_Tensor_t *outputTensors, const uint32_t numOutputs
) {
    if (tensorSet.version == QNN_TENSOR_SET_VERSION_1) {
