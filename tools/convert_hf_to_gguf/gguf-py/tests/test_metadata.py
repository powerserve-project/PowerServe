...
class TestMetadataMethod(unittest.TestCase):
    ...
    def test_get_model_id_components(self):
        ...
        self.assertEqual(
            gguf.Metadata.get_model_id_components("Mixtral-8x7B"), ("Mixtral-8x7B", None, "Mixtral", None, None, "8x7B")
        )

        # Base name and version only
        self.assertEqual(
            gguf.Metadata.get_model_id_components("Mixtral-v0.1"), ("Mixtral-v0.1", None, "Mixtral", None, "v0.1", None)
        )

        ## Edge Cases ##

        # This is too ambiguous... best to err on caution and output nothing
        self.assertEqual(gguf.Metadata.get_model_id_components("Mixtral"), ("Mixtral", None, None, None, None, None))
        ...
        self.assertEqual(
            gguf.Metadata.get_model_id_components("voxmenthe/SFR-Iterative-DPO-LLaMA-3-8B-R-unquantized"),
            (
    ...
    def test_apply_metadata_heuristic_from_hf_parameters(self):
        ...
        expect = gguf.Metadata(
            name="Hermes 2 Pro Llama 3 8b DPO", finetune="DPO", basename="hermes-2-pro-llama-3", size_label="8B"
        )
        self.assertEqual(got, expect)
