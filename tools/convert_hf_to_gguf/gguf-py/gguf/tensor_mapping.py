...
class TensorNameMap:
    mappings_cfg: dict[MODEL_TENSOR, tuple[str, ...]] = {
        ...
        # Position embeddings
        MODEL_TENSOR.POS_EMBD: ("transformer.wpe", "embeddings.position_embeddings", "wpe"),  # gpt2  # bert  # gpt2
        # Output
        MODEL_TENSOR.OUTPUT: (
            "embed_out",  # gptneox
        ...
        # Rope frequencies
        MODEL_TENSOR.ROPE_FREQS: ("rope.freqs", "rotary_pos_emb.inv_freq"),  # llama-pth  # chatglm
    }
    ...
    block_mappings_cfg: dict[MODEL_TENSOR, tuple[str, ...]] = {
        ...
        MODEL_TENSOR.ATTN_POST_NORM: ("model.layers.{bid}.post_attention_layernorm",),  # gemma2
        # Rotary embeddings
        ...
        # Post feed-forward norm
        MODEL_TENSOR.FFN_POST_NORM: ("model.layers.{bid}.post_feedforward_layernorm",),  # gemma2
        ...
        MODEL_TENSOR.SSM_IN: ("model.layers.{bid}.in_proj", "backbone.layers.{bid}.mixer.in_proj"),
        MODEL_TENSOR.SSM_CONV1D: ("model.layers.{bid}.conv1d", "backbone.layers.{bid}.mixer.conv1d"),
        MODEL_TENSOR.SSM_X: ("model.layers.{bid}.x_proj", "backbone.layers.{bid}.mixer.x_proj"),
        MODEL_TENSOR.SSM_DT: ("model.layers.{bid}.dt_proj", "backbone.layers.{bid}.mixer.dt_proj"),
        MODEL_TENSOR.SSM_A: ("model.layers.{bid}.A_log", "backbone.layers.{bid}.mixer.A_log"),
        MODEL_TENSOR.SSM_D: ("model.layers.{bid}.D", "backbone.layers.{bid}.mixer.D"),
        MODEL_TENSOR.SSM_OUT: ("model.layers.{bid}.out_proj", "backbone.layers.{bid}.mixer.out_proj"),
        MODEL_TENSOR.TIME_MIX_W1: ("rwkv.blocks.{bid}.attention.time_maa_w1",),  # rwkv v6
        MODEL_TENSOR.TIME_MIX_W2: ("rwkv.blocks.{bid}.attention.time_maa_w2",),  # rwkv v6
        MODEL_TENSOR.TIME_MIX_LERP_X: ("rwkv.blocks.{bid}.attention.time_maa_x",),  # rwkv v6
        MODEL_TENSOR.TIME_MIX_LERP_K: ("rwkv.blocks.{bid}.attention.time_maa_k",),  # rwkv v6
        MODEL_TENSOR.TIME_MIX_LERP_V: ("rwkv.blocks.{bid}.attention.time_maa_v",),  # rwkv v6
        MODEL_TENSOR.TIME_MIX_LERP_R: ("rwkv.blocks.{bid}.attention.time_maa_r",),  # rwkv v6
        MODEL_TENSOR.TIME_MIX_LERP_G: ("rwkv.blocks.{bid}.attention.time_maa_g",),  # rwkv v6
        MODEL_TENSOR.TIME_MIX_LERP_W: ("rwkv.blocks.{bid}.attention.time_maa_w",),  # rwkv v6
        MODEL_TENSOR.TIME_MIX_FIRST: ("rwkv.blocks.{bid}.attention.time_faaaa",),  # rwkv v6
        MODEL_TENSOR.TIME_MIX_DECAY: ("rwkv.blocks.{bid}.attention.time_decay",),  # rwkv v6
        MODEL_TENSOR.TIME_MIX_DECAY_W1: ("rwkv.blocks.{bid}.attention.time_decay_w1",),  # rwkv v6
        MODEL_TENSOR.TIME_MIX_DECAY_W2: ("rwkv.blocks.{bid}.attention.time_decay_w2",),  # rwkv v6
        ...
        MODEL_TENSOR.TIME_MIX_RECEPTANCE: ("rwkv.blocks.{bid}.attention.receptance",),  # rwkv
        ...
        MODEL_TENSOR.CHANNEL_MIX_LERP_K: ("rwkv.blocks.{bid}.feed_forward.time_maa_k",),  # rwkv v6
        MODEL_TENSOR.CHANNEL_MIX_LERP_R: ("rwkv.blocks.{bid}.feed_forward.time_maa_r",),  # rwkv v6
        MODEL_TENSOR.CHANNEL_MIX_KEY: ("rwkv.blocks.{bid}.feed_forward.key",),  # rwkv
        MODEL_TENSOR.CHANNEL_MIX_RECEPTANCE: ("rwkv.blocks.{bid}.feed_forward.receptance",),  # rwkv
        MODEL_TENSOR.CHANNEL_MIX_VALUE: ("rwkv.blocks.{bid}.feed_forward.value",),  # rwkv
