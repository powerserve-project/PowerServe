...
class SpecialVocab:
    ...
    def _try_load_from_tokenizer_json(self, path: Path) -> bool:
        ...
        for typ in self.special_token_types:
            ...
            maybe_token_id = next((atok.get("id") for atok in added_tokens if atok.get("content") == tc_content), None)
...
class LlamaHfVocab(Vocab):
    ...
    def __init__(self, base_path: Path):
        ...
        self.tokenizer = AutoTokenizer.from_pretrained(base_path, cache_dir=base_path, local_files_only=True)
